...
type OrdenProductos = 'nombre-asc' | 'nombre-desc' | 'precio-asc' | 'precio-desc' | 'stock-asc' | 'stock-desc'
...
export default function ProductosPage() {
  ...
  const eliminarProducto = async (id: string, nombre: string) => {
    if (!confirm(`¿Desactivar producto "${nombre}"?\n\nNo se eliminará del historial de ventas.`)) return
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-neutral-900 to-stone-900 p-8 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-light text-white mb-2">Productos</h1>
            <p className="text-zinc-400 font-light">Gestión de inventario</p>
          </div>
          <Button
            onClick={() => abrirModal()}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="bajo" className="bg-zinc-900">Stock bajo</option>
                    <option value="normal" className="bg-zinc-900">Stock normal</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="nombre-asc" className="bg-zinc-900">Nombre (A-Z)</option>
                    <option value="nombre-desc" className="bg-zinc-900">Nombre (Z-A)</option>
                    <option value="precio-asc" className="bg-zinc-900">Precio (menor a mayor)</option>
                    <option value="precio-desc" className="bg-zinc-900">Precio (mayor a menor)</option>
                    <option value="stock-asc" className="bg-zinc-900">Stock (menor a mayor)</option>
                    <option value="stock-desc" className="bg-zinc-900">Stock (mayor a menor)</option>
                  </select>
                </div>
        ...
        <div className="mb-4 text-sm text-zinc-400">
          Mostrando <span className="font-semibold text-white">{productosFiltrados.length}</span> de{' '}
          <span className="font-semibold text-white">{productos.length}</span> productos
        </div>
        ...
        {productosFiltrados.length === 0 ? (
          <div className="text-center py-16 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
            ...
            {productos.length === 0 && (
              <Button onClick={() => abrirModal()} className="bg-white text-zinc-900 hover:bg-zinc-100">
                <Plus className="w-4 h-4 mr-2" />
                Crear Producto
              </Button>
            )}
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-gradient-to-br from-zinc-900 via-neutral-900 to-stone-900 border border-white/10 rounded-xl max-w-md w-full p-6 animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="precio" className="text-zinc-300">Precio</Label>
                <Input
                  id="precio"
                  type="number"
                  step="0.01"
              ...
              <div>
                <Label htmlFor="stock_minimo" className="text-zinc-300">Stock Mínimo</Label>
                <Input
                  id="stock_minimo"
                  type="number"
